export const language = {
  description: {
    english: 'Town Hall Project is a 501(c)(3) non-profit organization dedicated to lifting up the voices of Americans to lawmakers and other people in power. We created Mutual Aid Hub to highlight the incredible work of mutual aid organizers around the country, and to facilitate connections and shared strategies in this growing movement of community support.',
    spanish: 'Town Hall Project es una organización 501(c)(3) sin ánimo de lucro dedicada a elevar las voces de los estadounidenses a los legisladores y otras personas en el poder. Creamos Mutual Aid Hub para recalcar el increíble trabajo de los organizadores de ayuda mutua en todo el país, y para facilitar las conexiones y compartir estrategias en este movimiento creciente de apoyo comunitario.'
  },
  disclaimer: {
  ...
  title: {
    ...
    spanish: 'Este sitio está construido y mantenido por'
  }
}